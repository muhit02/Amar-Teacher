...
class EnglishProfilePage1 extends StatelessWidget {
  const EnglishProfilePage1({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage('lib/assets/images/english.jpg'),
            ),
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    _showBottomSheet(context, 'Email', 'englishd@gmail.com');
                  },
                ),
                IconButton(
            ...
            const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('MA in English University of Rajshahi.', style: TextStyle(fontSize: 16)),
                  SizedBox(height: 20),
