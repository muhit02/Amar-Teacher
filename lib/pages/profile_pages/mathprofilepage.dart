...
class MathProfilePage1 extends StatelessWidget {
  const MathProfilePage1({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage('lib/assets/images/devid.png'),
            ),
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    _showBottomSheet(context, 'Email', 'devid@gmail.com');
                  },
                ),
                IconButton(
            ...
            const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('Bachelor of Science in Mathematics Education from University of Rajshahi.', style: TextStyle(fontSize: 16)),
                  SizedBox(height: 20),
