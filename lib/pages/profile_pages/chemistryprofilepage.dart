...
class ChemistryProfilePage1 extends StatelessWidget {
  const ChemistryProfilePage1({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage('lib/assets/images/chemistry.jpg'),
            ),
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    _showBottomSheet(context, 'Email', 'chemistry@gmail.com');
                  },
                ),
                IconButton(
            ...
            const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('Masters Degrees in Chemistry University of Rajshahi.', style: TextStyle(fontSize: 16)),
                  SizedBox(height: 20),
