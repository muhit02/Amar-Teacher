...
class BioProfilePage1 extends StatelessWidget {
  const BioProfilePage1({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage('lib/assets/images/fahad.jpeg'),
            ),
            const SizedBox(height: 10),
            const Text(
              'Md. Fahad Ibna Mahafuz',
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    _showBottomSheet(context, 'Email', 'Fahad@gmail.com');
                  },
                ),
                IconButton(
            ...
            const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('MBBS from Dhaka Medical College. MBBS from Dhaka Medical College.', style: TextStyle(fontSize: 16)),
                  SizedBox(height: 20),
                  Text('Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 10),
                  Text('House # 2, Road # 5, kadirgonj, Rajshahi, Bangladesh', style: TextStyle(fontSize: 16)),
                  SizedBox(height: 20),
